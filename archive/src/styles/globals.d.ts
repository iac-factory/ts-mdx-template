...
export declare module Interface {
    ...
    module Base {
        type Red = Omit<{
            [Color in keyof Contravariant<Color.Variable["Red"]>]: Color;
        }, "Hover">;
        type Blue = Omit<{
            [Color in keyof Contravariant<Color.Variable["Blue"]>]: Color;
        }, "Hover">;
        type Green = Omit<{
            [Color in keyof Contravariant<Color.Variable["Green"]>]: Color;
        }, "Hover">;
        type Gray = Omit<{
            [Color in keyof Contravariant<Color.Variable["Gray"]>]: Color;
        }, "Hover">;
        type Purple = Omit<{
            [Color in keyof Contravariant<Color.Variable["Purple"]>]: Color;
        }, "Hover">;
        type Magenta = Omit<{
            [Color in keyof Contravariant<Color.Variable["Magenta"]>]: Color;
        }, "Hover">;
        type Orange = Omit<{
            [Color in keyof Contravariant<Color.Variable["Orange"]>]: Color;
        }, "Hover">;
        type Yellow = Omit<{
            [Color in keyof Contravariant<Color.Variable["Yellow"]>]: Color;
        }, "Hover">;
        type Teal = Omit<{
            [Color in keyof Contravariant<Color.Variable["Teal"]>]: Color;
        }, "Hover">;
    }
    module Hover {
        type Red = {
            [Color in keyof Contravariant<Color.Variable["Red"]["Hover"]>]: Color;
        };
        type Blue = {
            [Color in keyof Contravariant<Color.Variable["Blue"]["Hover"]>]: Color;
        };
        type Green = {
            [Color in keyof Contravariant<Color.Variable["Green"]["Hover"]>]: Color;
        };
        type Gray = {
            [Color in keyof Contravariant<Color.Variable["Gray"]["Hover"]>]: Color;
        };
        type Purple = {
            [Color in keyof Contravariant<Color.Variable["Purple"]["Hover"]>]: Color;
        };
        type Magenta = {
            [Color in keyof Contravariant<Color.Variable["Magenta"]["Hover"]>]: Color;
        };
        type Orange = {
            [Color in keyof Contravariant<Color.Variable["Orange"]["Hover"]>]: Color;
        };
        type Yellow = {
            [Color in keyof Contravariant<Color.Variable["Yellow"]["Hover"]>]: Color;
        };
        type Teal = {
            [Color in keyof Contravariant<Color.Variable["Teal"]["Hover"]>]: Color;
        };
    }
    export type Red = {
...
export declare const Colors: Interface.Color;
